...
int CPipe::Swing( int fFirst )
{
	...
	if ( tr.flFraction >= 1.0 )
	{
		if ( fFirst )
		{
			...
			{
			case 0:
				SendWeaponAnim( PIPE_ATTACK1MISS );
				break;
			case 1:
				SendWeaponAnim( PIPE_ATTACK2MISS );
				break;
			case 2:
				SendWeaponAnim( PIPE_ATTACK3MISS );
				break;
			}
			// miss
			...
			{
			case 0:
				EMIT_SOUND( ENT( m_pPlayer->pev ), CHAN_WEAPON, "weapons/pipe_miss1.wav", 1, ATTN_NORM );
				break;
			case 1:
				EMIT_SOUND( ENT( m_pPlayer->pev ), CHAN_WEAPON, "weapons/pipe_miss1.wav", 1, ATTN_NORM );
				break;
	...
	else
	{
		...
		{
		case 0:
			SendWeaponAnim( PIPE_ATTACK1HIT );
			break;
		case 1:
			SendWeaponAnim( PIPE_ATTACK2HIT );
			break;
		case 2:
			SendWeaponAnim( PIPE_ATTACK3HIT );
			break;
		}

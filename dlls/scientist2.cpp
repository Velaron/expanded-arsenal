...
class CScientist2 : public CTalkMonster
{
public:
	void Spawn( void );
	void Precache( void );
...
LINK_ENTITY_TO_CLASS( monster_cleansuit_scientist, CScientist2 );
LINK_ENTITY_TO_CLASS( monster_cleansuit, CScientist2 );

TYPEDESCRIPTION CScientist2::m_SaveData[] = {
	DEFINE_FIELD( CScientist2, m_painTime, FIELD_TIME ),
	DEFINE_FIELD( CScientist2, m_healTime, FIELD_TIME ),
	DEFINE_FIELD( CScientist2, m_fearTime, FIELD_TIME ),
};

IMPLEMENT_SAVERESTORE( CScientist2, CTalkMonster );
...
Task_t tlFaceTarget2Scared2[] = {
	{ TASK_FACE_TARGET, (float)0 },
	{ TASK_SET_ACTIVITY, (float)ACT_CROUCHIDLE },
	{ TASK_SET_SCHEDULE, (float)SCHED_TARGET_CHASE_SCARED },
};

Schedule_t slFaceTarget2Scared2[] = {
	{ tlFaceTarget2Scared2,
	  ARRAYSIZE( tlFaceTarget2Scared2 ),
...
Schedule_t slIdleSciStand2[] = {
	{ tlIdleSciStand2,
	  ...
	  bits_COND_NEW_ENEMY | bits_COND_LIGHT_DAMAGE | bits_COND_HEAVY_DAMAGE | bits_COND_HEAR_SOUND | bits_COND_SMELL | bits_COND_CLIENT_PUSH | bits_COND_PROVOKED,
...
Schedule_t slScientistHide2[] = {
	{ tlScientistHide2,
	  ...
	  bits_COND_NEW_ENEMY | bits_COND_HEAR_SOUND | bits_COND_SEE_ENEMY | bits_COND_SEE_HATE | bits_COND_SEE_FEAR | bits_COND_SEE_DISLIKE,
	  bits_SOUND_DANGER,
	  "ScientistHide" },
};
...
DEFINE_CUSTOM_SCHEDULES( CScientist2 ) {
	slFollow2,
	slFaceTarget2,
	slIdleSciStand2,
	slFear2,
	...
	slSciPanic2,
	slFollowScared2,
	slFaceTarget2Scared2,
};

IMPLEMENT_CUSTOM_SCHEDULES( CScientist2, CTalkMonster );

void CScientist2::DeclineFollowing( void )
{
	Talk( 10 );
...
void CScientist2 ::StartTask( Task_t *pTask )
{
	switch ( pTask->iTask )
	{
	case TASK_SAY_HEAL:
...
void CScientist2 ::RunTask( Task_t *pTask )
{
	switch ( pTask->iTask )
	{
	case TASK_RUN_PATH_SCARED:
...
//=========================================================
void CScientist2 ::SetYawSpeed( void )
{
	int ys;
...
//=========================================================
void CScientist2 ::HandleAnimEvent( MonsterEvent_t *pEvent )
{
	switch ( pEvent->event )
	{
...
void CScientist2 ::TalkInit()
{
	...
	m_szFriends[1] = "monster_sitting_scientist2";
	m_szFriends[2] = "monster_barney2";
...
int CScientist2 ::TakeDamage( entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int bitsDamageType )
{
...
//=========================================================
int CScientist2 ::ISoundMask( void )
{
...
// PainSound
//=========================================================
void CScientist2 ::PainSound( void )
{
...
// DeathSound
//=========================================================
void CScientist2 ::DeathSound( void )
{
	PainSound();
}

void CScientist2::Killed( entvars_t *pevAttacker, int iGib )
{
	SetUse( NULL );
	CTalkMonster::Killed( pevAttacker, iGib );
}

void CScientist2 ::SetActivity( Activity newActivity )
{
	int iSequence;
...
Schedule_t *CScientist2 ::GetScheduleOfType( int Type )
{
	Schedule_t *psched;
...
Schedule_t *CScientist2 ::GetSchedule( void )
{
...
int CScientist2::FriendNumber( int arrayNumber )
{
...
// Dead Scientist PROP
//=========================================================
class CDeadScientist2 : public CBaseMonster
{
public:
	void Spawn( void );
...
LINK_ENTITY_TO_CLASS( monster_cleansuit_scientist_dead, CDeadScientist2 );

//
// ********** DeadScientist SPAWN **********
//
void CDeadScientist2 ::Spawn()
{
	PRECACHE_MODEL( "models/scientist2.mdl" );
	SET_MODEL( ENT( pev ), "models/scientist2.mdl" );
...
class CSittingScientist2 : public CScientist2 // kdb: changed from public CBaseMonster so he can speak
{
public:
	void Spawn( void );
	void Precache( void );
...
LINK_ENTITY_TO_CLASS( monster_sitting_scientist2, CSittingScientist2 );
TYPEDESCRIPTION CSittingScientist2::m_SaveData[] = {
	// Don't need to save/restore m_baseSequence (recalced)
	DEFINE_FIELD( CSittingScientist2, m_headTurn, FIELD_INTEGER ),
	DEFINE_FIELD( CSittingScientist2, m_flResponseDelay, FIELD_FLOAT ),
};

IMPLEMENT_SAVERESTORE( CSittingScientist2, CScientist2 );
...
void CSittingScientist2 ::Spawn()
{
	...
	SetThink( &CSittingScientist2::SittingThink );
	pev->nextthink = gpGlobals->time + 0.1;

	DROP_TO_FLOOR( ENT( pev ) );
}

void CSittingScientist2 ::Precache( void )
{
	m_baseSequence = LookupSequence( "sitlookleft" );
	TalkInit();
}
...
//=========================================================
int CSittingScientist2 ::Classify( void )
{
	return CLASS_HUMAN_PASSIVE;
}

int CSittingScientist2::FriendNumber( int arrayNumber )
{
...
// sit, do stuff
//=========================================================
void CSittingScientist2 ::SittingThink( void )
{
	CBaseEntity *pent;
...
void CSittingScientist2 ::SetAnswerQuestion( CTalkMonster *pSpeaker )
{
...
//=========================================================
int CSittingScientist2 ::FIdleSpeak( void )
{
